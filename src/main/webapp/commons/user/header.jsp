			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					...
					<li><c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/user/profile"><c:out value="${sessionScope.account.fullname}"/></a>
			...
			<ul>
				...
				<li class="dropdown active"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
    					...
    					<li><a href="${pageContext.request.contextPath}/user/profile">Thông tin cá nhân</a></li></c:if>
